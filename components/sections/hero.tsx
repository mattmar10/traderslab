...
function HeroTitles() {
  return (
    ...
    >
      ...
      >
        Outperform the market with data-driven strategies.
      </motion.p>
    </div>
  );
}
  ...
  return (
    <section id="hero">
      <div className="relative flex w-full flex-col items-center justify-start px-4  sm:px-6 pt-4 md:pt-32 lg:px-8">
        ...
        <HeroCTA />
        <HeroImage />
        <div className="pointer-events-none absolute inset-x-0 -bottom-12 h-1/3 bg-gradient-to-t from-background via-background to-transparent lg:h-1/6"></div>
      </div>
    </section>
  );
}
