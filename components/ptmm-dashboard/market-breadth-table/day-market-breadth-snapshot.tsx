...
const MobileDayMarketBreadthTable: React.FC<MobileMarketBreadthTableProps> = ({
  overview,
  mb,
  datasetName,
  ...
  return (
    <ExpandableCard title={`${datasetName} Snapshot`} initiallyExpanded={true}>
      <div className="w-full " key={`mob-breadth-snap-table-row-${dateStr}`}>
        ...
        <div className="w-full mt-4">
          ...
          <div className={`text-sm w-full flex flex-col text-foreground/70`}>
        ...
        <div className="w-full mt-4">
          ...
          <div className={`text-sm w-full flex flex-col`}>
            ...
            <div className={`${firaCode.className} flex justify-between pb-1`}>
              <div
                className="flex-1 text-left pl-1"
                style={{ backgroundColor: tenEMABackground }}
              >
                {Number(mb?.greaterThanSMARow.percentAboveTenEMA.toFixed(0))}%
              </div>
              <div
              ...
              >
                {Number(
                  mb?.greaterThanSMARow.percentAboveTwentyOneEMA.toFixed(0)
                )}
                %
              </div>
              <div
              ...
              >
                {Number(mb?.greaterThanSMARow.percentAboveFiftySMA.toFixed(0))}%
              </div>
              <div
              ...
              >
                {Number(
                  mb?.greaterThanSMARow.percentAboveTwoHundredSMA.toFixed(0)
                )}
                %
              </div>
            </div>
...
export default MobileDayMarketBreadthTable;
