      ...
      <div className="container">
        <div className=" mx-auto">
          <div className="mx-auto my-12 h-full grid lg:grid-cols-2 gap-10 items-center">
                ...
                {data.map((item, index) => (
                  ...
                  >
                    {linePosition === "left" || linePosition === "right" ? (
                      ...
                      >
                        <div
                          ...
                          } origin-top bg-traderslabblue transition-all ease-linear dark:bg-white`}
                          style={{
                            transitionDuration:
                              currentIndex === index
                                ? `${collapseDelay}ms`
                    ...
                    {linePosition === "top" || linePosition === "bottom" ? (
                      ...
                      >
                        <div
                          ...
                          } origin-left bg-traderslabblue transition-all ease-linear dark:bg-white`}
                          style={{
                            transitionDuration:
                              currentIndex === index
                                ? `${collapseDelay}ms`
                    ...
                    <div className="flex items-center relative">
                      <div className="item-box w-12 h-12 bg-traderslabblue/10 rounded-full sm:mx-6 mx-2 shrink-0 flex items-center justify-center">
                        {item.icon}
                      </div>
            ...
            <div
              className={`h-[400px] min-h-[200px] w-full ${
                ltr && "lg:order-1"
              }`}
            >
                  ...
                  <div className="absolute bottom-0 left-0 right-auto top-0 h-0.5 w-full overflow-hidden rounded-lg bg-neutral-300/50 dark:bg-neutral-300/30">
                    <div
                      className={`absolute left-0 top-0 h-full ${
                        currentIndex === index ? "w-full" : "w-0"
                      } origin-top bg-traderslabblue transition-all ease-linear`}
                      style={{
                        transitionDuration:
