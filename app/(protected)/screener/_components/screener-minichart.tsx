...
import { ColorType, createChart, CrosshairMode, ISeriesApi, LineData, MouseEventParams, Time } from "lightweight-charts";
        ...
        <div className={`relative ${className}`}>
            ...
            >
                <div>
                    ...
                    {adrP && !isADRPercentError(adrP) && <span>, <span className="font-semibold">ADRP:</span>  {adrP.toFixed(2)}%</span>}
                </div>
                {ticker.includes("^") && (
