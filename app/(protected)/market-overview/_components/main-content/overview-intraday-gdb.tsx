...
const OverviewIntradayGDB: React.FC = () => {
        ...
        if (data && typeof data !== "string") {
            ...
            const filteredData = data
                ...
                .map((snapshot) => ({
                    ...
                    NYSE: Number(snapshot.nyseOverview.globalDailyBreadthPercentileRank.toFixed(2)),
                    "S&P 500": Number(snapshot.rspTradingOverview.globalDailyBreadthPercentileRank.toFixed(2)),
                    NDX100: Number(snapshot.qqqETradingOverview.globalDailyBreadthPercentileRank.toFixed(2)),
                    "Russell 2000": Number(snapshot.iwmTradingOverview.globalDailyBreadthPercentileRank.toFixed(2)),
                }));
    ...
    if (isLoading) return <div className="place-items-center"><Loading /></div>;
                                    ...
                                    formatter={(value, name) => {
                                        ...
                                        return (
                                            <>
                                                ...
                                                />
                                                <span key="label" className="ml-2 font-semibold">{config?.label || name}</span >
