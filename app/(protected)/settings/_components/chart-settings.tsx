...
import { ChartSettings, defaultChartSettings, MovingAverageSetting, VolumeMovingAverageSetting } from "@/components/settings/chart-settings";
...
export default function ChartSettingsCard() {
    ...
    const [settings, setSettings] = useState<ChartSettings>(loadSettignsFromStorage());
