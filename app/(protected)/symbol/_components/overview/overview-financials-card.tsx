...
const IncomeStatementChart: React.FC<OverviewFinancialsCardProps> = ({ incomeStatement }) => {
    const colors = {
    ...
    const revenueRegression = calculateLinearRegression(chartData, 'period', 'revenue');
    const epsRegression = calculateLinearRegression(chartData, 'period', 'epsDiluted');
