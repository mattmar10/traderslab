...
import { solarizedBase01, solarizedBlue, solarizedYellow } from "@/lib/utils/color-utils";
...
const Beta: React.FC<BetaProps> = ({
    ...
    const { beta, regressionLine } = useMemo(() => {
        if (!scatterData.length) return { beta: 0, regressionLine: null };
        ...
        const beta = parseFloat((covariance / variance).toFixed(2));
        ...
        return { beta, regressionLine: lineData };
    }, [scatterData]);
        ...
        <Card className="w-full">
            ...
            <CardContent className="grid grid-cols-4 gap-4">
                ...
                <div className="h-[30rem] col-span-3">
                    <div className="text-lg font-semibold ml-4">Beta: {beta}</div>
                            ...
                            >
                                ...
                                <Tooltip
                                    content={({ active, payload }) => {
                                        ...
                                        // Ensure the data has the necessary properties
                                        return (
                                            <div className="rounded-lg border bg-background p-2 shadow-sm w-">
                                    ...
                                    // Add a filter for tooltip events only at scatter points
